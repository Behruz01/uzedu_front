...
const MainNav = () => {
    return (
        <div className="flex justify-between containr mt-16 gap-10 mainNav_section">
            ...
            <div className="flex w-1/2 gap-5 mainNav_text cursor-pointer items-center bg-[#f0f220] rounded-lg px-10 group hover:bg-[#4c4083] ">
                <FaEnvelopeOpenText className="w-14 h-14 text-[#4c4083]  group-hover:text-white" />
                <p className="text-[#4c4083] text-xl font-bold group-hover:text-white ">
